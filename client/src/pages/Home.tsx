...
function Profile() {
  return <><PageHeader eyebrow="ACCOUNT & IDENTITY" title="Student profile" description="Your academic identity and contact information in one place." action={<button className="outline-button"><Settings size={16} /> Account settings</button>} /><div className="profile-layout"><section className="surface-card profile-identity"><div className="profile-cover"><div className="profile-avatar">AS</div></div><div className="profile-body"><h2>Atik Shahriar</h2><p>BSc in CSE · Semester 4</p><span className="verified-badge"><ShieldCheck size={14} /> Verified student</span><div className="identity-meta"><div><small>Student ID</small><strong>230042116</strong></div><div><small>Batch</small><strong>2023</strong></div></div></div></section><section className="surface-card details-card"><div className="table-heading"><div><span className="eyebrow">PERSONAL INFORMATION</span><h2>Contact details</h2></div><button className="text-button">Edit details</button></div><div className="details-grid"><div><small>University email</small><strong>atikshahriar16@iut-dhaka.edu</strong></div><div><small>Phone number</small><strong>+880 1712 345 678</strong></div><div><small>Department</small><strong>CSE</strong></div><div><small>Program</small><strong>BSC in CSE</strong></div><div><small>Date of birth</small><strong>9 February 2003</strong></div><div><small>Nationality</small><strong>Bangladeshi</strong></div></div></section><section className="surface-card advisor-card"><span className="eyebrow">ACADEMIC ADVISOR</span><div className="advisor-row"><div className="avatar avatar-medium">RH</div><div><strong>Reaz Hasan Joarder</strong><span>Lecturer · CSE</span><small>reaz.hasan.joarder@iut-dhaka.edu</small></div><button className="icon-button"><ArrowRight size={16} /></button></div></section></div></>;
}
